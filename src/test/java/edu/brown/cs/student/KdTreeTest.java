...
//    System.out.println(tree1.getArrayOfKnnIds(threeD, kdArraySimple, 1)[0]);
    assertEquals(100, tree1.getArrayOfKnnIds(threeD, kdArraySimple, 1)[0]);
    assertEquals(101, tree1.getArrayOfKnnIds(threeD, kdArraySimple, 2)[1]);
    assertEquals(101, tree1.getArrayOfKnnIds(threeD2, kdArraySimple, 1)[0]);
  }
}
